...
// useAppConfig is auto-imported by the @nuxt/ui/vite plugin
// (runtime/vue/composables is registered in unplugin-auto-import dirs).
declare function useAppConfig(): { ui: { colors: { primary: string, neutral: string } } }
