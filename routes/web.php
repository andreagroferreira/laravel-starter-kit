...
use App\Http\Controllers\Settings\IntegrationCallbackController;
use App\Http\Controllers\Settings\IntegrationController;
use App\Http\Controllers\Settings\IntegrationRedirectController;
...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::prefix('settings')->name('settings.')->group(function (): void {
        ...
        Route::get('/integrations/{provider}/redirect', IntegrationRedirectController::class)->name('integrations.redirect');
        Route::get('/integrations/{provider}/callback', IntegrationCallbackController::class)->name('integrations.callback');
